...
export const InfoCard = (): JSX.Element => {
  ...
  return (
    <div>
      <h2 className='w-full mb-5 text-3xl text-center font-semibold text-white z-10'> What Is The Sumak Kawsay <em className='bg-gradient-to-r from-orange-600 to-white text-transparent bg-clip-text'>Ecosystem</em>?</h2>
