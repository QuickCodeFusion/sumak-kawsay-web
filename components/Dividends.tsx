  ...
  return (
        <div >
            ...
            <div className="sketchfab-embed-wrapper">
                    <iframe className="h-[300px] rounded-full" title="Galxy Passport" frameBorder="0" allow="autoplay; fullscreen; xr-spatial-tracking" src="https://sketchfab.com/models/e3cf2f1ed20b425b96bc0522cf91bb8c/embed"> </iframe>
