...
const CardTeamWork = ({ user }: { user: { name: string, role: string, img: string, description: string } }): React.JSX.Element => {
  return (
    <Card className='md:w-5/6 min-h-96 rounded-3xl border border-vivid-violet-600 shadow-sm shadow-vivid-violet-800 bg-background/50 px-10 py-3 flex flex-col justify-start text-cente'>
