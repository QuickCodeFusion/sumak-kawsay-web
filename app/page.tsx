...
const Home = (): React.JSX.Element => {
  ...
  return (
        <main className='flex flex-col gap-64 pt-8 mt-10 px-8 justify-center items-center w-screen overflow-x-hidden bg-no-repeat bg-[53%_8.5%] md:bg-[53%_3.5%] bg-[length:325%] bg-norepeat md:bg-[length:100%] bg-[url("/fondofooter.png")]'>
